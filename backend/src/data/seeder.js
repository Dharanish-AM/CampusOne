...
const busRoutesData = [
  ...
  {
    "routeName": "Perumanallur - Tirupur Pandiyan nager (Via New bus stand,Veerapandi,Palladam) - Bus 33",
    "routeCode": "BUS-33",
    "stops": [
      {
        "name": "Perumanallur",
...
const seedDatabase = async () => {
  try {
    ...
    for (const item of createdUsers) {
      ...
      createdStudentProfiles.push({ profile: studentProfile, studentData: item.studentData, user: item.user });
    }
